...
export const MOBILE_SPLASHSCREEN = require("../assets/images/splashscreen_logo.png");
export const DEFAULT_ICON = require("../assets/images/icon.png");
export const DEFAULT_ADAPTIVE_ICON = require("../assets/images/adaptive-icon.png");

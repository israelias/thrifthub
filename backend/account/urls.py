...
urlpatterns = [
    path("account/login/", views.AccountLoginDetailView.as_view(), name="token_obtain_pair"),
    ...
    path("account/register/", views.AccountRegisterDetailView.as_view(), name="account_register"),
    path(
        "account/change_password/<int:pk>/", views.AccountChangePasswordView.as_view(), name="account_change_password"
    ),
    path("account/update_profile/<int:pk>/", views.AccountUpdateView.as_view(), name="account_update_profile"),
    path("account/logout/", views.AccountLogoutView.as_view(), name="account_logout"),
    path("account/logout_all/", views.AccountLogoutAllView.as_view(), name="account_logout_all"),
